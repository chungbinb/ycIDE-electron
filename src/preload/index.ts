...
const api = {
  ...
  project: {
    ...
    saveAiChat: (projectDir: string, payload: unknown) => ipcRenderer.invoke('project:saveAiChat', projectDir, payload),
    loadAiChat: (projectDir: string) => ipcRenderer.invoke('project:loadAiChat', projectDir) as Promise<unknown>,
